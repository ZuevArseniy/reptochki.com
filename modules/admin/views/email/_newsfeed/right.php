...
<td valign="top" width="6"  bgcolor="fff8cf"></td>
<td valign="top" width="21"><img src="http://ckidki.by/assets/newsfeed/dbboxes-c.jpg" border="0" width="21" height="315"></td>
...
<td valign="top" width="304" bgcolor="fff8cf">
	<div style="position:relative;">
		<table width="304" cellspacing="0" bordercolordark="white" bordercolorlight="black" cellpadding="0">
			...
			<tr>
				<td width="292" bgcolor="#fde05f" colspan="2" style="padding: 5px 2px 5px 10px;">
				...
				<td>
					<table cellpadding="0" cellspacing="0">
						<tr>
							...
							<td style="padding:10px 0 0;" rowspan="2"><a href="#"><img src="http://ckidki.by/assets/newsfeed/button2.jpg" width="113" height="37" border="0"></a></td>
						</tr>
						<tr>
							<td width="191" style="padding: 7px 0 0;">
		...
		<!-- New stock fucking image 
		<img src="http://ckidki.by/assets/newsfeed/newdisc.gif" style="position:absolute; left:-16px; top:70px;">-->
	</div>
</td>
<td valign="top" width="6"  bgcolor="fff8cf"></td>
<td valign="top" width="9"><img src="http://ckidki.by/assets/newsfeed/dbboxes-r.jpg" border="0" width="9" height="315"></td>
<?endif;?>