<script type="text/javascript">
    ...
    ymaps.ready(function () {
        ...
        var myMap = new ymaps.Map('map', {
            center: [<?=$city->lat?>, <?=$city->lon?>], // Москва
            zoom: 12,
    ...
    <form class="form-horizontal" method="post" name='add'>
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?=Phone::render($studio->phones,$city,$city->country,Phone::EDIT);?>
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                <label class="control-label" for="input02">Краткое описание (для вывода в списке)</label>
                <div class="controls">
                    <textarea class="span6" name='preview_text' id="textarea_1" rows="30" cols='100' style='width:620px;height: 200px' style="margin: 0px; height: 54px; width: 320px; "><?=$studio->preview_text?></textarea>
                </div>
            </div>
            <div class="control-group">
