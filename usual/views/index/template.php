...
<head>
    <meta charset="utf-8">
    <title>Репетиционные базы</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <META Name="keywords" Content="реп базы, реп точки, репетиция, харьков, донецк, минск, одесса ">
    <META Name="description" Content="Репетиционные студии твоего города">
...
background-position: 0 3px;" class="muted">eptochki.by</h3>
    ...
    <hr>
    <div class="jumbotron">
        <h1>Репетиционные базы твоего города!</h1>
        <p class="lead">Найди свой звук!</p>
        <?=$content?>
    </div>
    <hr>
    <div class="footer">
