...
var R = {
    ...
    init:function (lat, lng,zoom) {
        ...
        var osm = L.tileLayer('http://{s}.tile.cloudmade.com/170820bcc2f3411395f33ab9cdee29df/997/256/{z}/{x}/{y}.png', {
    ...
    setHandlers:function () {
        ...
        map.on('popupopen', function (event) {
            if(!R.source){
                ...
                $('#schedule-' + event.popup.options.id).show().addClass('schedule-active').carousel('cycle');
                R.source = null;
        ...
        $('#studio-list').on('click','.accordion-heading a',function(){
            if(!R.source){
                ...
                if(R.active == id){
                    ...
                    $('.carousel').carousel('pause');
                    $('.schedule-active').hide().removeClass('schedule-active');
                    $('#schedule-' + id).show().addClass('schedule-active').carousel('cycle');
                    R.source = null;
                }}
